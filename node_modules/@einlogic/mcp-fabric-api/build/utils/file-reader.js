...
export async function readFilesFromDirectory(dirPath, extensions) {
...
export async function writeFilesToDirectory(dirPath, files) {
    const absolutePath = resolve(dirPath);
    const written = [];
...
export async function resolveContentOrFile(content, filePath, fieldName) {
    if (content && filePath) {
...
export async function resolveFilesOrDirectory(files, dirPath, extensions) {
