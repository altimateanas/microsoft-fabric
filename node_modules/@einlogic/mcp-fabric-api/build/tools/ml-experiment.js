...
export function registerMlExperimentTools(server, fabricClient, workspaceGuard) {
    server.tool("ml_experiment_list", "List all ML experiments in a workspace", { workspaceId: z.string().describe("The workspace ID") }, READ, async ({ workspaceId }) => {
        try {
    ...
    server.tool("ml_experiment_get", "Get details of a specific ML experiment", {
        workspaceId: z.string().describe("The workspace ID"),
        mlExperimentId: z.string().describe("The ML experiment ID"),
    }, READ, async ({ workspaceId, mlExperimentId }) => {
        try {
    ...
    server.tool("ml_experiment_create", "Create a new ML experiment in a workspace (long-running)", {
        workspaceId: z.string().describe("The workspace ID"),
    ...
    server.tool("ml_experiment_update", "Update an ML experiment's name or description", {
        workspaceId: z.string().describe("The workspace ID"),
        mlExperimentId: z.string().describe("The ML experiment ID"),
        displayName: z.string().optional().describe("New display name"),
        description: z.string().optional().describe("New description"),
    }, WRITE, async ({ workspaceId, mlExperimentId, displayName, description }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
            const body = {};
    ...
    server.tool("ml_experiment_delete", "Delete an ML experiment", {
        workspaceId: z.string().describe("The workspace ID"),
        mlExperimentId: z.string().describe("The ML experiment ID"),
    }, DESTRUCTIVE, async ({ workspaceId, mlExperimentId }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
...
//# sourceMappingURL=ml-experiment.js.map