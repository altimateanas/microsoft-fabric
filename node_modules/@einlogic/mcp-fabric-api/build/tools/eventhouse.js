...
export function registerEventhouseTools(server, fabricClient, kustoClient, workspaceGuard) {
    server.tool("eventhouse_list", "List all eventhouses in a workspace", { workspaceId: z.string().describe("The workspace ID") }, READ, async ({ workspaceId }) => {
        try {
    ...
    server.tool("eventhouse_get", "Get details of a specific eventhouse", {
        workspaceId: z.string().describe("The workspace ID"),
        eventhouseId: z.string().describe("The eventhouse ID"),
    }, READ, async ({ workspaceId, eventhouseId }) => {
        try {
    ...
    server.tool("eventhouse_create", "Create a new eventhouse in a workspace (long-running operation)", {
        workspaceId: z.string().describe("The workspace ID"),
    ...
    server.tool("eventhouse_update", "Update an eventhouse's name or description", {
        workspaceId: z.string().describe("The workspace ID"),
        eventhouseId: z.string().describe("The eventhouse ID"),
        displayName: z.string().optional().describe("New display name"),
        description: z.string().optional().describe("New description"),
    }, WRITE, async ({ workspaceId, eventhouseId, displayName, description }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
            const body = {};
    ...
    server.tool("eventhouse_delete", "Delete an eventhouse", {
        workspaceId: z.string().describe("The workspace ID"),
        eventhouseId: z.string().describe("The eventhouse ID"),
    }, DESTRUCTIVE, async ({ workspaceId, eventhouseId }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
    ...
    server.tool("eventhouse_get_sql_endpoint", "Get the query service URI and connection details for an eventhouse", {
        workspaceId: z.string().describe("The workspace ID"),
        eventhouseId: z.string().describe("The eventhouse ID"),
    }, READ, async ({ workspaceId, eventhouseId }) => {
        try {
            ...
            const result = {};
            if (properties.queryServiceUri)
                result.queryServiceUri = properties.queryServiceUri;
            if (properties.ingestionServiceUri)
                result.ingestionServiceUri = properties.ingestionServiceUri;
            if (properties.databaseName)
                result.databaseName = properties.databaseName;
    ...
    server.tool("eventhouse_execute_kql", "Execute a KQL query against an eventhouse's KQL database", {
        workspaceId: z.string().describe("The workspace ID"),
        eventhouseId: z.string().describe("The eventhouse ID"),
    ...
    }, WRITE, async ({ workspaceId, eventhouseId, database, query, maxRows }) => {
        try {
            const response = await fabricClient.get(`/workspaces/${workspaceId}/eventhouses/${eventhouseId}`);
            const properties = response.data.properties;
            const queryServiceUri = properties?.queryServiceUri;
            if (!queryServiceUri) {
                return {
...
//# sourceMappingURL=eventhouse.js.map