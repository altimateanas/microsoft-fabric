...
export function registerDeploymentPipelineTools(server, fabricClient, workspaceGuard) {
    server.tool("deployment_pipeline_list", "List all deployment pipelines accessible to the user", {}, READ, async () => {
        try {
    ...
    server.tool("deployment_pipeline_get", "Get details of a specific deployment pipeline", { pipelineId: z.string().describe("The deployment pipeline ID") }, READ, async ({ pipelineId }) => {
        try {
    ...
    server.tool("deployment_pipeline_create", "Create a new deployment pipeline", {
    ...
    }, WRITE, async ({ displayName, description }) => {
        try {
    ...
    server.tool("deployment_pipeline_update", "Update a deployment pipeline's name or description", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
        displayName: z.string().optional().describe("New display name"),
        description: z.string().optional().describe("New description"),
    }, WRITE, async ({ pipelineId, displayName, description }) => {
        try {
            const body = {};
    ...
    server.tool("deployment_pipeline_delete", "Delete a deployment pipeline", { pipelineId: z.string().describe("The deployment pipeline ID") }, DESTRUCTIVE, async ({ pipelineId }) => {
        try {
    ...
    server.tool("deployment_pipeline_list_stages", "List all stages in a deployment pipeline", { pipelineId: z.string().describe("The deployment pipeline ID") }, READ, async ({ pipelineId }) => {
        try {
    ...
    server.tool("deployment_pipeline_list_stage_items", "List all items in a specific deployment pipeline stage", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
        stageId: z.string().describe("The stage ID"),
    }, READ, async ({ pipelineId, stageId }) => {
        try {
    ...
    server.tool("deployment_pipeline_assign_workspace", "Assign a workspace to a deployment pipeline stage", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
        stageId: z.string().describe("The stage ID"),
        workspaceId: z.string().describe("The workspace ID to assign"),
    }, WRITE, async ({ pipelineId, stageId, workspaceId }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
            const response = await fabricClient.post(`/deploymentPipelines/${pipelineId}/stages/${stageId}/assignWorkspace`, { workspaceId });
    ...
    server.tool("deployment_pipeline_unassign_workspace", "Unassign a workspace from a deployment pipeline stage", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
        stageId: z.string().describe("The stage ID"),
        workspaceId: z.string().describe("The workspace ID to unassign"),
    }, DESTRUCTIVE, async ({ pipelineId, stageId, workspaceId }) => {
        try {
            await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
            const response = await fabricClient.post(`/deploymentPipelines/${pipelineId}/stages/${stageId}/unassignWorkspace`, { workspaceId });
    ...
    server.tool("deployment_pipeline_deploy", "Deploy items from one stage to another in a deployment pipeline (long-running)", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
    ...
    }, WRITE, async ({ pipelineId, sourceStageId, targetStageId, items, note, workspaceId }) => {
        try {
            if (workspaceId) {
                await workspaceGuard.assertWorkspaceAllowed(fabricClient, workspaceId);
            }
            const body = { sourceStageId };
            if (targetStageId)
                body.targetStageId = targetStageId;
            if (items)
                body.items = items;
            if (note)
                body.note = note;
    ...
    server.tool("deployment_pipeline_list_operations", "List operations (deployment history) for a deployment pipeline", { pipelineId: z.string().describe("The deployment pipeline ID") }, READ, async ({ pipelineId }) => {
        try {
    ...
    server.tool("deployment_pipeline_get_operation", "Get details of a specific deployment pipeline operation", {
        pipelineId: z.string().describe("The deployment pipeline ID"),
        operationId: z.string().describe("The operation ID"),
    }, READ, async ({ pipelineId, operationId }) => {
        try {
...
//# sourceMappingURL=deployment-pipeline.js.map